...
public class constants {
    ...
    public class MechConstants{
        ...
        public class IntakeConstants {
            ...
            public static final double kReverseIntakeSpeed = -0.50;
        ...
        /**Shooter Subsystem Constants */
            ...
            public static final double kShootingSpeed1 = -0.40;
            public static final double kShootingSpeed2 = -0.30;
            public static final double kReverseShooterSpeed = 0.32;
            public static final double kKillShooter = 0.0;

            public static final double kPIDShootSpeed = 0;
           //40 for passing
             /** public static final double kEncoderOffset = 0;*/

             public static final double kGearRatio = 2.8;
        }
